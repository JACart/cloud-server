const CARTID = require('./connections').cartID
const { json } = require('express')
const model = require('./Models/Cart')
const CartState = require('/Models/Cart').cartSchema

var cartstate:typeof CartState = {
  _id: CARTID,
  latitude: 0,
  longitude: 0,
  destination: '',
...
module.exports.connect = async (state: string) => {
  cartstate = state
...
module.exports.setDestination = async (name: string) => {
